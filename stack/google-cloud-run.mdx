...
description: "[Google Cloud Run](https://neon.tech) is used as our serverless compute platform for deploying cost-efficient containerized applications without having to manage the underlying infrastructure."
---
